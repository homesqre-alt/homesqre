    ...
    <DashShell links={LINKS} title="Designer Studio">
      ...
      <div className="mb-6">
        <p className="text-[#4A5D54] max-w-2xl text-sm">
          {activeTab.startsWith("leads") && "Leads assigned to you. Update status / add comments / set follow-ups exactly like sales — when the customer approves all renders, the lead automatically moves to 'Ready for Quotation' and reassigns to admin."}
      ...
      {activeTab.startsWith("leads") && <MasterLeadPipeline mode="sales" currentUser={user} />}
